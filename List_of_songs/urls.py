...
urlpatterns = [
    ...
    url(r'^user/(?P<user_id>(\d)+)/change$', UserDetailsChangeView.as_view(), name="change user details"),
    ...
    url(r'^songs/tag/(?P<tag_name>(.*?))$', SongsWithTagView.as_view()),
    ...
    url(r'^song/(?P<song_id>(\d)+)/(?P<event_id>(\d)+)/set_voices$', SongSetVoicesView.as_view()),
    url(r'^song/(?P<song_id>(\d)+)/(?P<event_id>(\d)+)/edit$', EditSongView.as_view()),
    url(r'^song/(?P<song_id>(\d)+)/add_file$', SongAddFileView.as_view()),
    url(r'^song/(?P<song_id>(\d)+)/delete$', SongDeleteView.as_view()),
