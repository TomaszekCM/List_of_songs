...
#         url = reverse('home')
#         self.assertEquals(resolve(url).func.view_class, AllSongsView)
#
...
#         self.assertEquals(resolve(url).func.view_class, UserDetailsChangeView)
#
...
#         self.assertEquals(resolve(url).func.view_class, AddSongView)
#
...
#         self.assertEquals(resolve(url).func.view_class, SongsWithTagView)
#
#     def test_song_url(self):
#         url = reverse('song', args=[4,5])
#         self.assertEquals(resolve(url).func.view_class, SongView)
#
#     def test_song_declaration_url(self):
#         url = reverse('song_declaration', args=[6,11])
#         self.assertEquals(resolve(url).func.view_class, SongDeclarationView)
#
#     def test_set_voices_in_song_url(self):
#         url = reverse('set_voices', args=[4, 66])
#         self.assertEquals(resolve(url).func.view_class, SongSetVoicesView)
#
#     def test_edit_song_url(self):
#         url = reverse('edit_song', args=[1, 123])
#         self.assertEquals(resolve(url).func.view_class, EditSongView)
#
#     def test_add_file_to_song_url(self):
#         url = reverse('add_file_to_song', args=[2])
#         self.assertEquals(resolve(url).func.view_class, SongAddFileView)
#
#     def test_delete_song_url(self):
#         url = reverse('delete_song', args=[44])
#         self.assertEquals(resolve(url).func.view_class, SongDeleteView)
#
#     def test_backup_url(self):
#         url = reverse('backup')
#         self.assertEquals(resolve(url).func.view_class, BackupView)
#
